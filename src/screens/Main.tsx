    ...
    <View style={styles.container}>
      <VStack>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <Text fontFamily={'Inter_700Bold'} fontSize={'2xl'} color='#393E46' mb={2}>Serviços</Text>
          ...
          <Text fontFamily={'Inter_600SemiBold'} fontSize={'2xl'} color='#393E46' my={4}>Melhores colaboradores</Text>
          <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
